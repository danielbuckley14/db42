...
class Paddle:
    ...
    def __str__(self):
        ...
        desc = "This class creates an instance of a paddle. Using only private instance variables the paddle has: x coordinates %s, and y coordinates %s, a width of %s, a height of %s, and a speed of %s. \n" % (self.__paddle_x, self.__paddle_y, self.__paddle_WIDTH, self.__paddle_HEIGHT, self.__paddle_speed)
        return desc
    ...
    #these allow to further the idea of a class template by adding flexibility for the programmer
    #We support encapsulation as using using getters and setters we ensure we dont
    #accidentally change attributes of other classes.
    #getters and setters allow us to modify variables outside the scope of the class
